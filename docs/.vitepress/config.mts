          ...
          '/en/': [
            ...
            },
            {
              ...
              items: [
                ...
                { text: 'Agent Skills', link: '/en/configuration/skills' },
                { text: 'MCP', link: '/en/configuration/mcp' },
                { text: 'Persistent Memory', link: '/en/configuration/memory' },
                { text: 'Economy Mode', link: '/en/configuration/economy' },
          ...
          '/it/': [
            ...
            },
            {
              ...
              items: [
                ...
                { text: 'Agent Skills', link: '/it/configurazione/skills' },
                { text: 'MCP', link: '/it/configurazione/mcp' },
                { text: 'Memoria Persistente', link: '/it/configurazione/memory' },
                { text: 'Economy Mode', link: '/it/configurazione/economy' },
